...
public class ImageTargetRenderer implements GLSurfaceView.Renderer, RendererC
{
    private static final String LOGTAG = "ImageTargetRenderer";
    
    private VuforiaClass vuforiaAppSession;
    ...
    public ImageTargetRenderer(VuforiaActivity activity, VuforiaClass session)
    {
        mActivity = activity;
...
//            }
    ...
    public void renderFrame(State state, float[] projectionMatrix)
    {
     ...
     //       Log.i("Trackable Result", "WE FOUND SOMETHING HOLY CRAP");
        }else {
      //      Log.i("TRACKABLE RESULT", "NONE FOUND YET");
        ...
        for (int tIdx = 0; tIdx < state.getNumTrackableResults(); tIdx++) {
            ...
            if (!mActivity.getExtendedTracking()) {
