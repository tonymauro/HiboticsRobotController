...
//I took this from the vuforia sample application stuff for testing,
//i'll make my own once i learn some opengl or once i git gud

public class OpenGlView extends GLSurfaceView
{
    private static final String LOGTAG = "OpenGLView";
