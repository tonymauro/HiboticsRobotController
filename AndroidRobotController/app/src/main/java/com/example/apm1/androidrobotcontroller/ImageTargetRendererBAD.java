...
// * ORIGINALLY GOTTEN FROM GITHUB, DOESN'T WORK SO COMMENTING OUT
...
//
//
//public class ImageTargetRenderer implements GLSurfaceView.RendererC {
//
...
//    {
//        mRenderer = RendererC.getInstance();
//
...
//        if (RendererC.getInstance().getVideoBackgroundConfig().getReflection() == VIDEO_BACKGROUND_REFLECTION.VIDEO_BACKGROUND_REFLECTION_ON)
